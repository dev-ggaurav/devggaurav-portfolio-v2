<template>
  <div>
    <nav class="nav py-6">
      <div class="wrapper px-10 flex justify-between items-center">
          <div class="logo">
            <nuxt-link to="/">
                <h1 class="text-2xl font-semibold text-gray-700"> <span class="text-primary font-bold">dev</span>ggaurav.</h1>
            </nuxt-link>
          </div>
